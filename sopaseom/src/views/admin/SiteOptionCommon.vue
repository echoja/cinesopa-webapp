    ...
    return {
      form: {
        contact_email: {
          ...
          type: 'string',
          description:
            '대외적으로 사용할 공식 이메일입니다. 사이트 하단 푸터 영역에 표시되거나 견적서 등의 정보로 들어갑니다.',
        },
        address: {
          label: '사무실 주소',
          value: null,
        ...
        phone: {
          ...
          type: 'string',
          description:
            '사이트를 방문하는 사람들 입장에서 볼 수 있는 전화번호입니다. 하단 푸터 영역에 표시됩니다.',
        },
        cinesopa_license: {
          label: '씨네소파 사업자등록증',
          value: null,
        ...
        distribution_application_email: {
          ...
          type: 'table',
          description:
            '배급 의뢰를 받을 이메일을 설정합니다. 여러 개를 설정할 수 있습니다.',
          typedef: {
            email: {
              type: 'string',
              label: '이메일',
        ...
        show_application_email: {
          ...
          type: 'table',
          description:
            '공동체 상영 신청을 받을 이메일 및 공동체 상영 관련 알림 메일을 설정합니다. 여러 개를 설정할 수 있습니다.',
          typedef: {
            email: {
              type: 'string',
              label: '이메일',
        ...
        shopping_email: {
          ...
          type: 'table',
          description:
            '소파섬 판매와 같은 상품 관련 알림 메일을 설정합니다. 여러 개를 설정할 수 있습니다.',
          typedef: {
            email: {
              type: 'string',
              label: '이메일',
