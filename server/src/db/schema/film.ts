...
import { getFilmSearchStr, makeSchemaHaveSearch } from "./tool";
import { enumPeopleRoleType, enumFilmWatchGrade, enumFilmTypeName, enumFilmStatus, enumFilmAvailableSubtitle } from "./enum";
import tagSchemaMaker from "./tag";
...
module.exports = function (mongoose) {
  ...
  const schema = new mongoose.Schema({
    ...
    available_subtitles: [
      { type: String, enum: enumFilmAvailableSubtitle },
    ],
