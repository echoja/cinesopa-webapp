<template>
  <div>
    ...
    <p>
      ...
      은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여
      공지할 것입니다.
    </p>
    <p>
      ○ 본 방침은부터
    ...
    <ol>
      <li>
        ...
        보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간
        내에서 개인정보를 처리,보유합니다.
      </li>
      <li>
        ...
        <ul>
          <li>1.&lt;배급 의뢰 업무 진행></li>
          <li>
            &lt;배급 의뢰 업무 진행>와 관련한 개인정보는 수집.이용에 관한 동의일로부터 위 이용목적을
            위하여 보유.이용됩니다.
          </li>
          <li>보유근거 : 정보주체의 동의</li>
          <li>보유기간 : 목적 달성후 즉시 파기</li>
        </ul>
      </li>
      <li>
